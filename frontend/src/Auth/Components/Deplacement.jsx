...
const deplacementList = [
    { label : "Transport de marchandise amont",
      dialogOptions : [ {label : 'Transport de marchandises' , value : 1}]  
    },
    ...
    { label : "Déplacements domicile-travail",
      dialogOptions : [{ label : 'Transport de personnes' , value : 1}]  
    },
                    ...
                    <Grid container spacing={2} sx={{ paddingLeft: '16px', paddingRight: '16px' }}>
                        {selectedEmissionIndex !== null && (
                            ...
                            <select style={{ ...Styles.customSelect, width: '100%' }}>
                                {selectedEmissionIndex !== null && deplacementList[selectedEmissionIndex].dialogOptions.map((option, index) => (
