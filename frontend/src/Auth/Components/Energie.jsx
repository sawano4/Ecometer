...
function Energie({ energieList, setEnergieList }) {
        ...
        useEffect(() => {
            if (openDialog) {
                ...
                const selectedEmission = energieList[selectedEmissionIndex];
        ...
        const fetchCategory2Options = async (category1Value) => {
            try {
                ...
                const response = await axios.post('http://localhost:3000/api/categories/nextCategories', { 
                        ...
                        userSelectedCategories : [energieList[selectedEmissionIndex].dialogueOptions[0].label ]
        ...
        const handleCategory2Change = async (selectedCategory2Option) => {
            ...
            console.log(energieList[selectedEmissionIndex].dialogueOptions[0].label);
            console.log(selectedCategory2Option);
            fetchCategory3Options([energieList[selectedEmissionIndex].dialogueOptions[0].label , selectedCategory2Option]);
        };
                        ...
                        {selectedEmissionIndex !== null && (
                            <Grid item xs={12} md={12}>
                                ...
                                <select style={{ ...Styles.customSelect, width: '100%' }}>
                                    {energieList[selectedEmissionIndex].dialogueOptions.map((option, index) => (
