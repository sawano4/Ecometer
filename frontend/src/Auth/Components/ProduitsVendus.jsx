...
function Energie({ produitsVendusList, setProduitsVendusList }) {
        ...
        useEffect(() => {
            if (openDialog) {
                ...
                const selectedEmission = produitsVendusList[selectedEmissionIndex];
        ...
        const fetchCategory2Options = async (category1Value) => {
            try {
                ...
                const response = await axios.post('http://localhost:3000/api/categories/nextCategories', { 
                        ...
                        userSelectedCategories : [produitsVendusList[selectedEmissionIndex].dialogueOptions[0].label ]
        ...
        const handleCategory2Change = async (selectedCategory2Option) => {
            ...
            console.log(produitsVendusList[selectedEmissionIndex].dialogueOptions[0].label);
            console.log(selectedCategory2Option);
            fetchCategory3Options([produitsVendusList[selectedEmissionIndex].dialogueOptions[0].label , selectedCategory2Option]);
        };
    ...
    return (
        <div>
{produitsVendusList.map((emission, index) => (
                        ...
                        {selectedEmissionIndex !== null && (
                            <Grid item xs={12} md={12}>
                                ...
                                <select style={{ ...Styles.customSelect, width: '100%' }}>
                                    {produitsVendusList[selectedEmissionIndex].dialogueOptions.map((option, index) => (
