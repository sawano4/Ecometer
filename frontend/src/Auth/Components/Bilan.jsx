  ...
  return (
    <div>
      <ThemeProvider theme={newTheme}>
        <Paper elevation={3} sx={{ minHeight: 'fit-content', borderRadius: '15px', paddingTop: '40px', paddingBottom: '40px', paddingLeft: '55px', paddingRight: '55px' }}>
          <Grid container spacing={2.5}>
            <Grid item md={12} marginBottom={'40px'} xs={12}>
              <Typography style={Styles.TitreText} textAlign={{ xs: 'center', md: 'start' }}>
                Bilan Carbone
              </Typography>
            </Grid>
              ...
              <Grid container direction={'row'} spacing={2}>
                <Grid item md={4.2} xs={12}>
                  ...
                  <LocalizationProvider dateAdapter={AdapterDayjs} fullWidth>
                    <DatePicker slotProps={{ textField: { fullWidth: true , sx :{
                            borderRadius: '15px',
            ...
            <Grid item md={12} xs={12}>
              <Grid container direction="row-reverse">
                <Grid item md={'2.36'} xs={12}>
                  <Button variant="contained" fullWidth style={Styles.commencerButton} onClick={handleClick}>
                    Commencer
                  </Button>
                </Grid>
              </Grid>
