...
function EmissionsDirectes({ emissionsList, setEmissionsList }) {
        ...
        useEffect(() => {
            if (openDialog) {
                ...
                const selectedEmission = emissionsList[selectedEmissionIndex];
        ...
        const fetchCategory2Options = async (category1Value) => {
            try {
                ...
                const response = await axios.post('http://localhost:3000/api/categories/nextCategories', { 
                        ...
                        userSelectedCategories : [emissionsList[selectedEmissionIndex].dialogueOptions[0].label ]
        ...
        const handleCategory2Change = async (selectedCategory2Option) => {
            ...
            console.log(emissionsList[selectedEmissionIndex].dialogueOptions[0].label);
            console.log(selectedCategory2Option);
            fetchCategory3Options([emissionsList[selectedEmissionIndex].dialogueOptions[0].label , selectedCategory2Option]);
        };
