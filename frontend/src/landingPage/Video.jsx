function Video() {
  return (
    <div>
      <div className="relative bg-white-100 h-[130vh]  w-[100%]">
        <h1 className="text-center text-neutral-800 text-[7.5vh] font-bold font-['Eudoxus Sans'] my-[3%] ">
        ...
        <img
          ...
          alt="SVG Image"
        ></img>
        <div className=" absolute w-[100%] h-[70%]">
          <div className=" bg-white  shadow-[0px_40px_50px_-23px] rounded-[10px] rounded-b-lg h-[100%] w-[80%] mx-auto ">
